...
//  RF_WT08(0x66, 0x4C);//IF 600K 16M xtal //FCF3        RX's Fscale(change IF) = IF * 2^20 / (2 * Fxtal) = (600000 * 2^20)/(2*16000000) = 19660.8   19660=0x4CCC
    ...
    RF_WT08(0x67, 0x00);                //FCF4
                                        ...
                                        //        [6]  FMOD_TS
                                        //        [5:0]-
    RF_WT08(0x69, 0x20);		//CPA_DIG [2:0]¡GPA Matching Control.	DBFS_OFFSET[2:0]¡GDBFS fine tune in test mode
...
//bank 2
    SPI_BYTE(0x22);		
#if AGC_RXG_SEL == 77 
		SPI_WT(0x21, 0x77);              //RXG: PGA=011, BPF=10, Mixer=1(high), LNA=11(High)
#elif AGC_RXG_SEL == 57  
